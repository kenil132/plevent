            ...
            <form action="rguser.php" method="POST">
                <div class="modal-body">
                    ...
                    if (isset($_GET['rg_id'])) {
                        $rg_id = $_GET['rg_id'];
                        // echo $rg_id;
                        $query = "SELECT * FROM custom_event WHERE id='$rg_id' LIMIT 1";
                    ...
                    ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12"><br>
                                        Services
                                        <input type="text" name="service" class="form-control" value="<?php echo $row['selected_service']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12"><br>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12"><br>
                                        ...
                                        <select name="order_status" class="form-control" required>
                                            <option value="0" <?php $row['order_status'] == 0 ? "selected" : "" ?>><?php
                                                                                                                    ...
                                                                                                                    ?></option>
                                            <option value="0" <?php $row['order_status'] == 0 ? "selected" : "" ?>>Panding</option>
                                        ...
                                        <button type="submit" name="updateorderstatus1" class="btn btn-primary">Update</button>
                                        <!-- </div> -->
                                    </div>
                                </div>
                </div>
