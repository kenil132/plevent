...
<body style="background-color: #e3e2df;">
    ...
    <?php
    $query = "SELECT * FROM events WHERE id=7";
                ...
                <div class="slideback">
                    ...
                    <div class="swiper">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/b6.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/b4.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/b2.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/b1.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/b5.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
            ...
            ?>
                ...
                ?>
                        ...
                        <div class="container">
                            ...
                            <div class="col-lg-3 col-md-6" id="p22">
                                <?php
                                $query = "SELECT * FROM events WHERE id=8";
                                $query_run = mysqli_query($con, $query);
                                if (mysqli_num_rows($query_run) > 0) {
                                    foreach ($query_run as $rows) {
                                ?>
                    ...
                    <div class="col-lg-3 col-md-6" id="p22">
                        <?php
                        $query = "SELECT * FROM events WHERE id=9";
                        $query_run = mysqli_query($con, $query);
                        if (mysqli_num_rows($query_run) > 0) {
                            foreach ($query_run as $rows) {
                        ?>
