                ...
                <div class="slideback">
                    ...
                    <div class="swiper">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/w9.jfif">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/wedding1.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/w6.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/w2.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/w8.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
