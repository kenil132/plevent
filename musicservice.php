                ...
                <div class="slideback">
                    ...
                    <div class="swiper">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/m2.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/m1.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/m3.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/m4.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
                            <div class="swiper-slide"><img class="bgimg" id="blur" src="assets/m5.jpg">
                                <div class="centered"><?php echo $rows['ename']; ?></div>
                            </div>
            ...
            ?>
                ...
                ?>
                        ...
                        <div class="container">
                            ...
                            <div class="col-lg-3 col-md-6" id="p22">
                                <?php
                                $query = "SELECT * FROM events WHERE id=11";
                                $query_run = mysqli_query($con, $query);
                                if (mysqli_num_rows($query_run) > 0) {
                                    foreach ($query_run as $rows) {
                                ?>
                    ...
                    <div class="col-lg-3 col-md-6" id="p22">
                        <?php
                        $query = "SELECT * FROM events WHERE id=12";
                        $query_run = mysqli_query($con, $query);
                        if (mysqli_num_rows($query_run) > 0) {
                            foreach ($query_run as $rows) {
                        ?>
